...
server.on("/99.0", []() { server.send(200, "text/html", webPage);  setting = 180; });
server.on("/98.0", []() { server.send(200, "text/html", webPage);  setting = 180; });
server.on("/97.0", []() { server.send(200, "text/html", webPage);  setting = 171; });
server.on("/96.0", []() { server.send(200, "text/html", webPage);  setting = 171; });
server.on("/95.0", []() { server.send(200, "text/html", webPage);  setting = 171; });
server.on("/94.0", []() { server.send(200, "text/html", webPage);  setting = 171; });
server.on("/93.0", []() { server.send(200, "text/html", webPage);  setting = 171; });
server.on("/92.0", []() { server.send(200, "text/html", webPage);  setting = 162; });
server.on("/91.0", []() { server.send(200, "text/html", webPage);  setting = 162; });
server.on("/90.0", []() { server.send(200, "text/html", webPage);  setting = 162; });
...
server.on("/89.0", []() { server.send(200, "text/html", webPage);  setting = 162; });
server.on("/88.0", []() { server.send(200, "text/html", webPage);  setting = 162; });
server.on("/87.0", []() { server.send(200, "text/html", webPage);  setting = 153; });
server.on("/86.0", []() { server.send(200, "text/html", webPage);  setting = 153; });
server.on("/85.0", []() { server.send(200, "text/html", webPage);  setting = 153; });
server.on("/84.0", []() { server.send(200, "text/html", webPage);  setting = 153; });
server.on("/83.0", []() { server.send(200, "text/html", webPage);  setting = 153; });
server.on("/82.0", []() { server.send(200, "text/html", webPage);  setting = 144; });
server.on("/81.0", []() { server.send(200, "text/html", webPage);  setting = 144; });
server.on("/80.0", []() { server.send(200, "text/html", webPage);  setting = 144; });
...
server.on("/79.0", []() { server.send(200, "text/html", webPage);  setting = 144; });
server.on("/78.0", []() { server.send(200, "text/html", webPage);  setting = 144; });
server.on("/77.0", []() { server.send(200, "text/html", webPage);  setting = 135; });
server.on("/76.0", []() { server.send(200, "text/html", webPage);  setting = 135; });
server.on("/75.0", []() { server.send(200, "text/html", webPage);  setting = 135; });
server.on("/74.0", []() { server.send(200, "text/html", webPage);  setting = 135; });
server.on("/73.0", []() { server.send(200, "text/html", webPage);  setting = 135; });
server.on("/72.0", []() { server.send(200, "text/html", webPage);  setting = 126; });
server.on("/71.0", []() { server.send(200, "text/html", webPage);  setting = 126; });
server.on("/70.0", []() { server.send(200, "text/html", webPage);  setting = 126; });
...
server.on("/69.0", []() { server.send(200, "text/html", webPage);  setting = 126; });
server.on("/68.0", []() { server.send(200, "text/html", webPage);  setting = 126; });
server.on("/67.0", []() { server.send(200, "text/html", webPage);  setting = 117; });
server.on("/66.0", []() { server.send(200, "text/html", webPage);  setting = 117; });
server.on("/65.0", []() { server.send(200, "text/html", webPage);  setting = 117; });
server.on("/64.0", []() { server.send(200, "text/html", webPage);  setting = 117; });
server.on("/63.0", []() { server.send(200, "text/html", webPage);  setting = 117; });
server.on("/62.0", []() { server.send(200, "text/html", webPage);  setting = 108; });
server.on("/61.0", []() { server.send(200, "text/html", webPage);  setting = 108; });
server.on("/60.0", []() { server.send(200, "text/html", webPage);  setting = 108; });
...
server.on("/59.0", []() { server.send(200, "text/html", webPage);  setting = 108; });
server.on("/58.0", []() { server.send(200, "text/html", webPage);  setting = 108; });
server.on("/57.0", []() { server.send(200, "text/html", webPage);  setting = 99; });
server.on("/56.0", []() { server.send(200, "text/html", webPage);  setting = 99; });
server.on("/55.0", []() { server.send(200, "text/html", webPage);  setting = 99; });
server.on("/54.0", []() { server.send(200, "text/html", webPage);  setting = 99; });
server.on("/53.0", []() { server.send(200, "text/html", webPage);  setting = 99; });
server.on("/52.0", []() { server.send(200, "text/html", webPage);  setting = 90; });
server.on("/51.0", []() { server.send(200, "text/html", webPage);  setting = 90; });
server.on("/50.0", []() { server.send(200, "text/html", webPage);  setting = 90; });
...
server.on("/49.0", []() { server.send(200, "text/html", webPage);  setting = 90; });
server.on("/48.0", []() { server.send(200, "text/html", webPage);  setting = 90; });
server.on("/47.0", []() { server.send(200, "text/html", webPage);  setting = 81; });
server.on("/46.0", []() { server.send(200, "text/html", webPage);  setting = 81; });
server.on("/45.0", []() { server.send(200, "text/html", webPage);  setting = 81; });
server.on("/44.0", []() { server.send(200, "text/html", webPage);  setting = 81; });
server.on("/43.0", []() { server.send(200, "text/html", webPage);  setting = 81; });
server.on("/42.0", []() { server.send(200, "text/html", webPage);  setting = 72; });
server.on("/41.0", []() { server.send(200, "text/html", webPage);  setting = 72; });
server.on("/40.0", []() { server.send(200, "text/html", webPage);  setting = 72; });
...
server.on("/39.0", []() { server.send(200, "text/html", webPage);  setting = 72; });
server.on("/38.0", []() { server.send(200, "text/html", webPage);  setting = 72; });
server.on("/37.0", []() { server.send(200, "text/html", webPage);  setting = 63; });
server.on("/36.0", []() { server.send(200, "text/html", webPage);  setting = 63; });
server.on("/35.0", []() { server.send(200, "text/html", webPage);  setting = 63; });
server.on("/34.0", []() { server.send(200, "text/html", webPage);  setting = 63; });
server.on("/33.0", []() { server.send(200, "text/html", webPage);  setting = 63; });
server.on("/32.0", []() { server.send(200, "text/html", webPage);  setting = 54; });
server.on("/31.0", []() { server.send(200, "text/html", webPage);  setting = 54; });
server.on("/30.0", []() { server.send(200, "text/html", webPage);  setting = 54; });
...
server.on("/29.0", []() { server.send(200, "text/html", webPage);  setting = 54; });
server.on("/28.0", []() { server.send(200, "text/html", webPage);  setting = 54; });
server.on("/27.0", []() { server.send(200, "text/html", webPage);  setting = 45; });
server.on("/26.0", []() { server.send(200, "text/html", webPage);  setting = 45; });
server.on("/25.0", []() { server.send(200, "text/html", webPage);  setting = 45; });
server.on("/24.0", []() { server.send(200, "text/html", webPage);  setting = 45; });
server.on("/23.0", []() { server.send(200, "text/html", webPage);  setting = 45; });
server.on("/22.0", []() { server.send(200, "text/html", webPage);  setting = 36; });
server.on("/21.0", []() { server.send(200, "text/html", webPage);  setting = 36; });
server.on("/20.0", []() { server.send(200, "text/html", webPage);  setting = 36; });
...
server.on("/19.0", []() { server.send(200, "text/html", webPage);  setting = 36; });
server.on("/18.0", []() { server.send(200, "text/html", webPage);  setting = 36; });
server.on("/17.0", []() { server.send(200, "text/html", webPage);  setting = 27; });
server.on("/16.0", []() { server.send(200, "text/html", webPage);  setting = 27; });
server.on("/15.0", []() { server.send(200, "text/html", webPage);  setting = 27; });
server.on("/14.0", []() { server.send(200, "text/html", webPage);  setting = 27; });
server.on("/13.0", []() { server.send(200, "text/html", webPage);  setting = 27; });
server.on("/12.0", []() { server.send(200, "text/html", webPage);  setting = 18; });
server.on("/11.0", []() { server.send(200, "text/html", webPage);  setting = 18; });
server.on("/10.0", []() { server.send(200, "text/html", webPage);  setting = 18; });
...
server.on("/9.0", []() { server.send(200, "text/html", webPage);   setting = 18; });
server.on("/8.0", []() { server.send(200, "text/html", webPage);   setting = 18; });
server.on("/7.0", []() { server.send(200, "text/html", webPage);   setting = 9; });
server.on("/6.0", []() { server.send(200, "text/html", webPage);   setting = 9; });
server.on("/5.0", []() { server.send(200, "text/html", webPage);   setting = 9; });
server.on("/4.0", []() { server.send(200, "text/html", webPage);   setting = 9; });
server.on("/3.0", []() { server.send(200, "text/html", webPage);   setting = 9; });
server.on("/2.0", []() { server.send(200, "text/html", webPage);   setting = 0; });
server.on("/1.0", []() { server.send(200, "text/html", webPage);   setting = 0; });
server.on("/0.0", []() { server.send(200, "text/html", webPage);   setting = 0; });
  server.begin();
